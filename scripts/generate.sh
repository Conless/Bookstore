...
sed -i 's/throw Exception(UNKNOWN, "Given data was not found.");/return -1;/' ./generated/submit.cc
...
sed -i 's/throw Exception(UNKNOWN, "Duplicated data");/return -1;/' ./generated/submit.cc
